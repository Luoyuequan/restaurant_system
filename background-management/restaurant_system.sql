...
--
-- Current Database: `restaurant_system`
--

CREATE DATABASE /*!32312 IF NOT EXISTS */ `restaurant_system` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='管理员模块';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='网站基本设置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `base_setting`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `base_setting`
    ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `column`
VALUES (1, 0, '产品展示', 'Products', 2, 100, NULL, 1578376332610, 1578377520516, 0),
       (2, 0, '关于我们', 'About Us', 1, 1, NULL, 1578385557736, 1578385557736, 0),
       (3, 1, '川菜', 'Kawana', 2, 100, NULL, 1578385692362, 1578385692362, 0);
/*!40000 ALTER TABLE `column`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 3
  DEFAULT CHARSET = utf8 COMMENT ='栏目类型';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='公司信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `company_info`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `company_info`
    ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `message`
VALUES (1, 'demoData2', 'demoData2', '234235412', '127.0.0.1', 'demoData', 1578379655136, 1578379655136, 1, 0),
       (2, 'demoData', 'demoData', 'demoData', '127.0.0.1', 'demoData', 1578381378209, 1578381378209, 1, 0),
       (3, 'demoData', 'demoData', 'demoData', '127.0.0.1', 'demoData', 1578381835326, 1578381835326, 1, 0),
       (4, 'data', 'demoData', 'demoData', '127.0.0.1', 'demoData', 1578382362465, 1578382362465, 1, 0);
...
VALUES (1, 1, 'demoData', 1, NULL, 'demoData', 'demoData', 4, 0, 0, 0, 1, 1578290698879, 1578293118042);
/*!40000 ALTER TABLE `production_info`
    ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-01-08 21:43:53
